<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-actions>
            ...
            <v-dialog v-model="commentDiagram" width="500">
                <CommentCommand
    ...
    export default {
        ...
        methods: {
            ...
            async comment(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['comment'].href), params)
                        for(var k in temp.data) {
                            this.value[k]=temp.data[k];
                        }
                    }
            ...
            openComment() {
                this.commentDiagram = true;
            },
            closeComment() {
                this.commentDiagram = false;
            },
        },
    }
</script>
